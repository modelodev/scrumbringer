...
pub fn rule_decoder_decodes_typed_task_target_test() {
  let body =
    "{\"id\":1,\"workflow_id\":2,\"name\":\"Close task\",\"goal\":null,\"trigger\":{\"type\":\"task_closed\",\"task_type_id\":7},\"action\":{\"type\":\"create_task\",\"template_id\":11},\"status\":{\"type\":\"active\"},\"created_at\":\"2026-01-28T12:00:00Z\",\"template\":null}"
...
pub fn rule_decoder_rejects_active_rule_without_action_test() {
  let body =
    "{\"id\":1,\"workflow_id\":2,\"name\":\"Missing template\",\"goal\":null,\"trigger\":{\"type\":\"task_closed\",\"task_type_id\":7},\"action\":null,\"status\":{\"type\":\"active\"},\"created_at\":\"2026-01-28T12:00:00Z\",\"template\":null}"
...
pub fn rule_decoder_accepts_requires_review_without_action_test() {
  let body =
    "{\"id\":1,\"workflow_id\":2,\"name\":\"Missing template\",\"goal\":null,\"trigger\":{\"type\":\"task_closed\",\"task_type_id\":7},\"action\":null,\"status\":{\"type\":\"requires_review\",\"reason\":\"template_missing\"},\"created_at\":\"2026-01-28T12:00:00Z\",\"template\":null}"
