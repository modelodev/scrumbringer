...
- [ ] **1.1** Renombrar "Catálogo" → "Capacidades" en i18n
- [ ] **1.2** Renombrar "Automatización" → "Reglas" en i18n
- [ ] **1.3** Añadir separadores visuales en sidebar (CSS)
- [ ] **1.4** Añadir nuevos items al sidebar (Tarjetas, Tipos, Plantillas)
...
- [ ] **2.3** Añadir filtro por estado y checkbox "Mostrar vacías"
- [ ] **2.4** Añadir búsqueda por nombre
- [ ] **2.5** Integrar en router y navegación

### Fase 3: Vista Tipos de Tarea (Medio esfuerzo)

- [ ] **3.1** Backend: Añadir endpoints PATCH y DELETE para task-types
- [ ] **3.2** Backend: Añadir `tasks_count` al GET list
- [ ] **3.3** Crear `components/task_type_crud_dialog.gleam`
- [ ] **3.4** Crear `features/admin/task_types.gleam` (vista principal)
- [ ] **3.5** Integrar en router y navegación

### Fase 4: Vista Plantillas (Medio esfuerzo)

- [ ] **4.1** Backend: Añadir `rules_count` al GET list de templates
- [ ] **4.2** Crear `features/admin/templates.gleam` (vista principal)
- [ ] **4.3** Reutilizar/adaptar `task_template_crud_dialog.gleam` existente
- [ ] **4.4** Añadir hint contextual con link a Reglas
- [ ] **4.5** Integrar en router y navegación

### Fase 5: Hints Contextuales (Bajo esfuerzo)

- [ ] **5.1** Añadir hint en vista Reglas con link a Plantillas (usando `info_callout.gleam`)
- [ ] **5.2** Añadir hint en vista Plantillas con link a Reglas (usando `info_callout.gleam`)
