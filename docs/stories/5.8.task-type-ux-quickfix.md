...
- [ ] **Task 1: Tabla de tipos de tarea (Capacidad legible)** (AC: 1, 2, 5)
  - [ ] 1.1 Resolver nombre de capacidad desde la lista de capabilities disponible en el modelo y centralizarlo en helper reutilizable (evitar logica inline duplicada).
...
- [ ] **Task 2: Selector de icono sin slug tecnico** (AC: 3)
  - [ ] 2.1 Remover el texto tecnico en el trigger del icon picker y reutilizar etiqueta humana si existe catalogo/lookup.
