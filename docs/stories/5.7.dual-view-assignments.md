...
- [ ] **Task 1: Estructura base y routing** (AC: 1, 15)
  - [ ] 1.1 Añadir nueva ruta `/org/assignments` en router
  - [ ] 1.2 Crear módulo `features/assignments/view.gleam`
  - [ ] 1.3 Crear módulo `features/assignments/update.gleam`
  - [ ] 1.4 Añadir `AssignmentsModel` al estado de admin
  - [ ] 1.5 Verificar permisos de org admin en guard de ruta
  - [ ] 1.6 Añadir entrada en sidebar bajo "ORGANIZACIÓN"
...
- [ ] **Task 2: Toggle y estado de vista** (AC: 2)
  ...
  - [ ] 2.4 Preservar búsqueda al cambiar de modo
...
- [ ] **Task 4: Vista Por Proyecto** (AC: 3, 6, 8, 9, 11)
  ...
  - [ ] 4.2 Reutilizar formulario inline "Añadir usuario"
  - [ ] 4.3 Reutilizar dropdown de cambio de rol
  - [ ] 4.4 Reutilizar botón quitar con confirmación inline
  - [ ] 4.5 Añadir badge `⚠️ SIN MIEMBROS` para proyectos vacíos
  - [ ] 4.6 Añadir acciones de proyecto (editar nombre, eliminar)
...
- [ ] **Task 5: Vista Por Usuario** (AC: 4, 7, 8, 9, 10)
  ...
  - [ ] 5.2 Reutilizar formulario inline "Añadir a proyecto"
  - [ ] 5.3 Reutilizar dropdown de cambio de rol
  - [ ] 5.4 Reutilizar botón quitar
  - [ ] 5.5 Añadir badge `⚠️ SIN PROYECTOS` para usuarios sin asignaciones
...
- [ ] **Task 6: Búsqueda** (AC: 5)
  - [ ] 6.1 Implementar input de búsqueda con debounce
...
- [ ] **Task 7: API y datos** (AC: 3, 4, 6, 7, 8, 9)
  - [ ] 7.1 Reutilizar endpoints existentes para CRUD de membresías (base `/api/v1`)
...
- [ ] **Task 8: Responsive y accesibilidad** (AC: 14, 15)
  ...
  - [ ] 8.2 Áreas tappable 44x44px mínimo
  - [ ] 8.3 Focus management para navegación por teclado

- [ ] **Task 9: Tests**
  - [ ] 9.1 Tests unitarios para toggle y filtrado
  - [ ] 9.2 Tests de renderizado para project_card y user_card
  - [ ] 9.3 Tests de permisos (solo org admin)
