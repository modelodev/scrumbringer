...
- AC9 (mobile keeps /app/pool in the 3-panel layout): `apps/client/test/router_test.gleam::mobile_keeps_pool_route_test`
- AC10 (client decode contract for work sessions): `apps/client/test/now_working_update_test.gleam`
