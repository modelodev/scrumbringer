...
Si los chips se hacen reutilizables, extraer solo cuando card/card tree detail
...
4. **Eliminar obsolescencias.**
   ...
   - Buscar restos con:
     - `rg "task-detail-edit-actions|TabTasks|Tasks|Tareas|Card Trees|Hitos" apps/client/src apps/client/test`
