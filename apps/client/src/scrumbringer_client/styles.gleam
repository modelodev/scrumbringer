...
.task-card.preview-left .task-card-preview { left: auto; right: calc(100% + 8px); }",
    ...
    ".task-preview-actions { margin-top: 8px; display: flex; justify-content: flex-end; }",
    ".task-preview-link { font-size: 12px; color: var(--sb-link); background: transparent; border: none; padding: 0; }",
...
.drag-handle:active { cursor: grabbing; }",
    ...
    ".task-dependencies-header { margin-bottom: 12px; }",
    ...
    ".task-blocked-badge { display: inline-flex; align-items: center; gap: 4px; padding: 2px 6px; border-radius: 999px; border: 1px solid color-mix(in oklab, var(--sb-warning) 40%, var(--sb-border)); background: color-mix(in oklab, var(--sb-warning) 12%, var(--sb-surface)); color: var(--sb-warning); font-size: 11px; font-weight: 600; }",
