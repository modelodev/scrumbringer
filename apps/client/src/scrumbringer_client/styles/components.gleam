...
pub fn css() -> List(String) {
  [
    ...
    ".icon-picker-placeholder { font-size: var(--sb-font-base); color: var(--sb-muted); }",
    ...
    ".icon-picker-tab { padding: 6px 12px; font-size: var(--sb-font-sm); border-radius: 8px; background: var(--sb-elevated); border: 1px solid var(--sb-border); cursor: pointer; transition: all 0.15s; }",
    ".icon-picker-tab:hover { border-color: var(--sb-primary); }",
    ".icon-picker-tab.active { background: color-mix(in oklab, var(--sb-primary) 15%, var(--sb-elevated)); border-color: var(--sb-primary); color: var(--sb-primary); font-weight: var(--sb-weight-semibold); }",
