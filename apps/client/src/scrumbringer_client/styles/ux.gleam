...
pub fn css() -> List(String) {
  [
    ...
    ".modal-tabs { display: flex; gap: 8px; padding: 0 20px 12px; border-bottom: 1px solid var(--sb-border); background: var(--sb-surface-2); }",
    ".modal-tab { padding: 6px 14px; background: transparent; border: 1px solid transparent; border-radius: 999px; cursor: pointer; font-size: 13px; font-weight: 600; color: color-mix(in oklab, var(--sb-text) 68%, var(--sb-muted)); transition: all 0.15s; display: inline-flex; align-items: center; gap: 6px; }",
    ".modal-tab:hover { color: var(--sb-text); background: var(--sb-elevated); }",
    ".modal-tab.tab-active { color: var(--sb-text-strong); font-weight: 700; border-color: var(--sb-primary-subtle-border); background: var(--sb-primary-subtle-bg); box-shadow: 0 1px 0 rgba(0,0,0,0.04); }",
    ...
    ".task-detail-header .modal-close { position: absolute; top: 16px; right: 16px; background: none; border: none; font-size: 24px; color: var(--sb-muted); cursor: pointer; width: 40px; height: 40px; padding: 8px; line-height: 1; }",
    ...
    ".detail-label { font-weight: 600; color: var(--sb-muted-strong); }",
