...
pub fn css() -> List(String) {
  [
    ...
    ".guidance-definitions { margin: 0; display: flex; flex-wrap: wrap; gap: 6px 12px; max-width: none; font-size: var(--sb-font-sm); }",
    ".guidance-definition { min-width: 0; display: inline-flex; align-items: baseline; gap: 4px; }",
    ".guidance-term { color: var(--sb-muted-strong); font-weight: var(--sb-weight-semibold); }",
    ".guidance-description { margin: 0; }",
