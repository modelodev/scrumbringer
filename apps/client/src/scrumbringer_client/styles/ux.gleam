...
pub fn css() -> List(String) {
  [
    ...
    ".card-summary-block { display: flex; flex-direction: column; gap: 8px; padding: 12px; border: 1px solid color-mix(in oklab, var(--sb-border) 72%, transparent); border-radius: 10px; background: var(--sb-surface); }",
    ".card-summary-progress-line { color: var(--sb-text); font-size: var(--sb-font-md); font-weight: var(--sb-weight-semibold); line-height: var(--sb-line-body); }",
    ".card-summary-progress-bar { width: 100%; height: 8px; border-radius: var(--sb-radius-pill); overflow: hidden; background: color-mix(in oklab, var(--sb-border) 74%, transparent); }",
    ".card-summary-progress-fill { height: 100%; border-radius: inherit; background: var(--sb-primary); transition: transform var(--sb-transition-slow); }",
    ".card-summary-structure { display: grid; gap: 8px; }",
    ...
    ".card-open-in-menu, .task-open-in-menu { position: relative; display: inline-flex; }",
    ".card-open-in-trigger, .task-open-in-trigger { list-style: none; display: inline-flex; align-items: center; justify-content: center; min-height: 36px; border: 1px solid var(--sb-border); border-radius: 10px; background: var(--sb-elevated); color: var(--sb-text); padding: 0 12px; font-weight: var(--sb-weight-semibold); cursor: pointer; }",
    ".card-open-in-trigger::-webkit-details-marker, .task-open-in-trigger::-webkit-details-marker { display: none; }",
    ".card-open-in-menu:hover, .card-open-in-menu:focus-within, .card-open-in-menu[open], .task-open-in-menu:hover, .task-open-in-menu:focus-within, .task-open-in-menu[open] { z-index: 45; }",
    ".card-open-in-panel, .task-open-in-panel { display: none; position: absolute; top: calc(100% + 6px); right: 0; flex-direction: column; align-items: stretch; gap: 4px; min-width: 180px; max-width: min(260px, calc(100vw - 32px)); border: 1px solid var(--sb-border); border-radius: 10px; background: var(--sb-surface); padding: 6px; box-shadow: var(--sb-shadow-soft); }",
    ".card-open-in-menu:hover .card-open-in-panel, .card-open-in-menu:focus-within .card-open-in-panel, .card-open-in-menu[open] .card-open-in-panel, .task-open-in-menu:hover .task-open-in-panel, .task-open-in-menu:focus-within .task-open-in-panel, .task-open-in-menu[open] .task-open-in-panel { display: flex; }",
    ".card-open-in-item, .task-open-in-item { min-height: 34px; width: 100%; box-sizing: border-box; border: 0; border-radius: 8px; background: transparent; color: var(--sb-text); padding: 7px 9px; text-align: left; font-size: var(--sb-font-sm); font-weight: var(--sb-weight-semibold); text-decoration: none; cursor: pointer; }",
    ".card-open-in-item:hover, .card-open-in-item:focus-visible, .task-open-in-item:hover, .task-open-in-item:focus-visible { background: var(--sb-elevated); color: var(--sb-primary); outline: 2px solid color-mix(in oklab, var(--sb-primary) 22%, transparent); outline-offset: 1px; }",
    ...
    ".task-inspector-actions { padding-top: 2px; }",
    ...
    ".secondary-actions-item { min-height: 34px; width: 100%; box-sizing: border-box; border: 0; border-radius: 8px; background: transparent; color: var(--sb-text); padding: 6px 9px; text-align: left; font-size: var(--sb-font-sm); text-decoration: none; cursor: pointer; }",
    ...
    "@media (max-width: 640px) { html:has(.card-show), body:has(.card-show), html:has(.task-show), body:has(.task-show) { overflow: hidden; } .card-show, .task-show { padding: 0; align-items: stretch; justify-content: stretch; pointer-events: auto; } .card-show-panel.card-show-surface, .task-show-content { width: 100%; max-width: none; height: 100dvh; max-height: 100dvh; min-height: 0; border-radius: 0; padding: 0; box-shadow: none; } .card-show .card-show-header-block, .task-show .task-show-header-block { position: sticky; top: 0; z-index: 2; } .detail-header-block { padding: 14px 14px 10px; } .inspector-title-row { gap: 8px; } .inspector-actions, .task-inspector-actions { align-items: stretch; gap: 8px; } .inspector-primary-action, .task-inspector-actions > .btn:first-child, .task-inspector-edit-actions { flex: 1 1 100%; } .inspector-primary-action .btn, .task-inspector-actions > .btn:first-child, .task-inspector-edit-actions .btn { width: 100%; min-height: 44px; } .card-open-in-menu, .task-open-in-menu, .card-secondary-actions-menu, .secondary-actions-menu { flex: 0 0 auto; } .card-open-in-trigger, .task-open-in-trigger, .card-secondary-actions-trigger, .secondary-actions-trigger { min-height: 44px; min-width: 44px; } .card-open-in-panel, .task-open-in-panel, .card-secondary-actions-panel, .secondary-actions-panel { position: fixed; left: 12px; right: 12px; top: auto; bottom: 12px; width: auto; max-width: none; box-shadow: var(--sb-shadow-modal); } .card-open-in-item, .task-open-in-item, .card-secondary-actions-item, .secondary-actions-item { min-height: 44px; } .modal-body, .card-show-body, .task-show-body { padding: 12px 14px 18px; overflow-y: auto; flex: 1 1 auto; min-height: 0; } .detail-title { font-size: var(--sb-font-xl); } .detail-tabs { overflow-x: visible; } .detail-tab, .card-show-tab.detail-tab, .task-show-tab.detail-tab { flex: 1 1 0; min-width: 0; padding-inline: 6px; overflow: hidden; text-overflow: ellipsis; font-size: var(--sb-font-sm); } .task-show .task-show-tabs.detail-tabs { margin-top: 10px; min-height: 42px; padding-bottom: 0; } .task-inspector-facts { grid-template-columns: 1fr; } .card-move-dialog-shell { align-items: flex-end; padding: 8px; } .card-move-dialog { width: 100%; max-height: 82vh; border-radius: 12px; } .card-add-task-form { padding: 12px; } .detail-modal-overlay .modal-content.detail-modal-content { width: calc(100% - 16px); max-height: 88vh; } .hierarchy-detail-body { padding: 12px 16px 16px; } .task-parent-context { align-items: stretch; flex-direction: column; } .task-parent-context-actions { justify-content: stretch; } .task-parent-context-actions .btn { flex: 1 1 160px; min-height: 44px; } .task-details-intro-row { align-items: stretch; flex-direction: column; } .task-show-edit-grid { grid-template-columns: 1fr; } }",
    // =====================================================
  ]
}
