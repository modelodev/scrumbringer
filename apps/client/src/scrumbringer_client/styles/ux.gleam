...
pub fn css() -> List(String) {
  [
    ...
    ".inspector-shell { background: transparent; }",
    ".inspector-panel { isolation: isolate; }",
    ".inspector-header { display: flex; flex-direction: column; gap: 12px; }",
    ".inspector-title-row { display: flex; align-items: flex-start; justify-content: space-between; gap: 12px; min-width: 0; }",
    ".inspector-title-stack { display: flex; flex: 1 1 auto; min-width: 0; flex-direction: column; gap: 4px; }",
    ".inspector-title { min-width: 0; overflow-wrap: anywhere; }",
    ".inspector-state-line { color: var(--sb-muted-strong); font-size: var(--sb-font-sm); line-height: var(--sb-line-body); }",
    ".inspector-close { flex: 0 0 auto; }",
    ".inspector-actions { display: flex; flex-wrap: wrap; align-items: center; gap: 10px; min-width: 0; }",
    ".inspector-primary-action { display: inline-flex; align-items: center; min-width: 0; }",
    ".inspector-primary-action .btn, .task-inspector-actions > .btn, .task-inspector-edit-actions .btn { min-height: 36px; }",
    ...
    ".card-show-tabs.detail-tabs, .task-show-tabs.detail-tabs { display: flex; align-items: flex-end; justify-content: flex-start; align-self: stretch; width: 100%; min-height: 40px; gap: 4px; padding: 0; border-bottom: 1px solid color-mix(in oklab, var(--sb-border) 82%, transparent); }",
    ...
    ".card-summary-signal.is-blocked .card-summary-signal-icon { background: color-mix(in oklab, var(--sb-warning) 16%, var(--sb-surface)); color: var(--sb-warning-text); }",
    ".card-summary-signal.is-complete .card-summary-signal-icon { background: color-mix(in oklab, var(--sb-success) 14%, var(--sb-surface)); color: var(--sb-success-text); }",
    ".card-summary-signal-copy { display: flex; min-width: 0; flex-direction: column; gap: 2px; }",
    ...
    ".card-summary-description-text.muted { color: var(--sb-muted-strong); }",
    ...
    ".inspector-action-trigger { width: 40px; min-width: 40px; padding: 0; }",
    ".action-menu-panel { position: fixed; flex-direction: column; align-items: stretch; gap: 4px; min-width: 180px; max-width: min(260px, calc(100vw - 32px)); border: 1px solid var(--sb-border); border-radius: 10px; background: var(--sb-surface); padding: 6px; color: var(--sb-text); box-shadow: var(--sb-shadow-soft); z-index: 1200; }",
    ".action-menu-panel:popover-open { display: flex; }",
    ".action-menu-item { min-height: 34px; width: 100%; box-sizing: border-box; border: 0; border-radius: 8px; background: transparent; color: var(--sb-text); padding: 7px 9px; text-align: left; font: inherit; font-size: var(--sb-font-sm); font-weight: var(--sb-weight-semibold); text-decoration: none; cursor: pointer; }",
    ...
    ".card-tab.detail-tab, .card-show-tab.detail-tab, .task-tab.detail-tab, .task-show-tab.detail-tab { flex: 0 0 auto; width: auto; min-width: 112px; max-width: none; }",
    ...
    ".task-show .detail-header-block { padding: 20px 20px 14px; overflow: visible; }",
    ".task-show .detail-header { gap: 8px; }",
    ".task-show .detail-title { min-width: 0; font-size: var(--sb-font-2xl); overflow-wrap: anywhere; }",
    ".task-inspector-actions { padding-top: 0; }",
    ".task-inspector-actions > .btn:first-child, .task-inspector-edit-actions .btn:last-child { order: -1; }",
    ".task-inspector-edit-actions { display: inline-flex; align-items: center; gap: 8px; flex-wrap: wrap; }",
    ".task-inspector-no-primary { display: inline-flex; align-items: center; min-height: 36px; padding: 0 10px; border: 1px dashed color-mix(in oklab, var(--sb-border) 88%, transparent); border-radius: 10px; color: var(--sb-muted-strong); background: var(--sb-surface); font-size: var(--sb-font-sm); line-height: var(--sb-line-tight); }",
    ".task-show .task-show-tabs.detail-tabs { margin-top: 2px; min-height: 40px; padding: 0; }",
    ".task-show .task-show-tab.detail-tab { min-height: 38px; }",
    ...
    ".task-inspector-facts { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 10px 14px; }",
    ...
    ".guidance { color: var(--sb-muted); line-height: var(--sb-line-body); }",
    ".guidance-section { margin: 0 0 12px; padding-inline: 2px; max-width: var(--sb-measure-prose); font-size: var(--sb-font-base); }",
    ...
    ".card-work-group-title { color: var(--sb-muted-strong); font-size: var(--sb-font-xs); font-weight: var(--sb-weight-bold); letter-spacing: var(--sb-letter-label); line-height: var(--sb-line-tight); text-transform: uppercase; }",
