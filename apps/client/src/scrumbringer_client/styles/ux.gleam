...
pub fn css() -> List(String) {
  [
    ...
    ".task-metrics-grid, .card-metrics-grid, .hierarchy-metrics-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 10px 16px; padding: var(--sb-space-lg) 14px; border: 1px solid color-mix(in oklab, var(--sb-border) 70%, transparent); border-radius: var(--sb-radius-lg); background: color-mix(in oklab, var(--sb-elevated) 92%, transparent); }",
    "@media (max-width: 640px) { .task-metrics-grid, .card-metrics-grid, .hierarchy-metrics-grid { grid-template-columns: 1fr; } .detail-row { grid-template-columns: 1fr; gap: 6px; } }",
    ".task-metrics-empty, .card-metrics-loading, .hierarchy-metrics-loading, .card-metrics-empty, .hierarchy-metrics-empty { color: color-mix(in oklab, var(--sb-text) 64%, var(--sb-muted)); padding: 10px 12px; border: 1px dashed var(--sb-border); border-radius: 10px; background: var(--sb-surface-2); }",
    ".card-metrics-error, .hierarchy-metrics-error { color: var(--sb-error-text); padding: 8px 0; }",
