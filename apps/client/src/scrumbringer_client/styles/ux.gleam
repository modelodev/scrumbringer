...
pub fn css() -> List(String) {
  [
    ...
    ".modal-tabs.detail-tabs, .card-show-tabs.detail-tabs { display: flex; align-items: stretch; justify-content: center; align-self: stretch; width: 100%; min-height: 56px; gap: 8px; padding: 8px; border-bottom: 1px solid color-mix(in oklab, var(--sb-border) 82%, transparent); }",
    ...
    ".modal-body, .card-show-body { padding: 16px 20px 20px; overflow-y: auto; flex: 1; background: var(--sb-surface-1); }",
    ...
    ".card-tab.detail-tab, .card-show-tab.detail-tab, .task-tab.detail-tab, .modal-tab.detail-tab { flex: 1 1 0; width: 100%; max-width: 220px; }",
    ...
    ".task-detail-modal .detail-title-row { align-items: flex-start; margin-bottom: 8px; }",
    ".task-detail-modal .detail-title { min-width: 0; font-size: var(--sb-font-xl); overflow-wrap: anywhere; }",
    ".task-detail-modal .modal-tabs.detail-tabs { margin-top: 8px; min-height: 60px; padding: 8px 8px 10px; }",
    ".task-detail-modal .modal-tab.detail-tab { min-height: 40px; }",
    ".task-detail-body { padding-bottom: 24px; overscroll-behavior: contain; }",
    ...
    "@media (max-width: 640px) { html:has(.card-show), body:has(.card-show) { overflow: hidden; } .card-show { padding: 0; align-items: stretch; justify-content: stretch; pointer-events: auto; } .card-show-panel.card-detail { width: 100%; max-width: none; height: 100dvh; max-height: 100dvh; min-height: 0; border-radius: 0; padding: 0; box-shadow: none; } .card-show .card-show-header-block { position: sticky; top: 0; z-index: 2; } .detail-header-block { padding: 16px 16px 12px; } .modal-body, .card-show-body { padding: 12px 16px 16px; } .detail-title { font-size: var(--sb-font-xl); } .card-detail-actions { align-items: stretch; } .card-detail-actions .btn { flex: 1 1 148px; min-height: 44px; } .card-secondary-actions-menu { flex: 0 0 auto; } .card-secondary-actions-trigger { min-height: 44px; min-width: 44px; } .card-secondary-actions-panel { position: fixed; left: 12px; right: 12px; top: auto; bottom: 12px; width: auto; max-width: none; box-shadow: var(--sb-shadow-modal); } .card-secondary-actions-item { min-height: 44px; } .card-move-dialog-shell { align-items: flex-end; padding: 8px; } .card-move-dialog { width: 100%; max-height: 82vh; border-radius: 12px; } .card-add-task-form { padding: 12px; } .detail-modal-overlay .modal-content.detail-modal-content { width: calc(100% - 16px); max-height: 88vh; } .hierarchy-detail-body { padding: 12px 16px 16px; } .task-detail-modal { padding: 8px; align-items: stretch; justify-content: stretch; } .task-detail-modal .modal-content { width: 100%; max-width: none; height: calc(100dvh - 16px); max-height: calc(100dvh - 16px); min-height: 0; border-radius: 12px; } .task-detail-modal .modal-header-block { position: sticky; top: 0; z-index: 2; padding-bottom: 18px; } .task-detail-modal .modal-tabs { position: static; } .task-detail-modal .modal-tabs.detail-tabs { margin-top: 10px; min-height: 62px; padding-bottom: 10px; } .task-detail-modal .modal-footer { position: sticky; bottom: 0; z-index: 2; padding: 10px 12px; } .task-detail-footer .btn { min-height: 44px; } .task-detail-body { padding: 12px 12px 18px; } .task-detail-summary-grid { grid-template-columns: 1fr; } .task-parent-context { align-items: stretch; flex-direction: column; } .task-parent-context-actions { justify-content: stretch; } .task-parent-context-actions .btn { flex: 1 1 160px; min-height: 44px; } .task-details-intro-row { align-items: stretch; flex-direction: column; } .task-detail-edit-grid { grid-template-columns: 1fr; } }",
    // =====================================================
  ]
}
