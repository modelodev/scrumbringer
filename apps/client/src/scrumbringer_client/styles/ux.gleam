...
pub fn css() -> List(String) {
  [
    ...
    ".task-detail-modal .detail-header-block { padding: 16px 20px 14px; overflow: visible; }",
    ...
    "@media (max-width: 640px) { .card-detail-modal { padding: 8px; } .modal-content.card-detail { padding: 0; } .detail-header-block { padding: 16px 16px 12px; } .modal-body { padding: 12px 16px 16px; } .detail-title { font-size: var(--sb-font-xl); } .card-detail-tasks-section { } .card-add-task-form { padding: 12px; } .detail-modal-overlay .modal-content.detail-modal-content { width: calc(100% - 16px); max-height: 88vh; } .milestone-detail-body { padding: 12px 16px 16px; } .task-detail-modal { padding: 8px; align-items: stretch; justify-content: stretch; } .task-detail-modal .modal-content { width: 100%; max-width: none; height: calc(100dvh - 16px); max-height: calc(100dvh - 16px); min-height: 0; border-radius: 12px; } .task-detail-modal .modal-header-block { position: sticky; top: 0; z-index: 2; padding-bottom: 14px; } .task-detail-modal .modal-tabs { position: static; } .task-detail-modal .modal-footer { position: sticky; bottom: 0; z-index: 2; padding: 10px 12px; } .task-detail-footer .btn { min-height: 44px; } .task-detail-body { padding: 12px 12px 18px; } .task-detail-summary-grid { grid-template-columns: 1fr; } .task-details-intro-row { align-items: stretch; flex-direction: column; } .task-detail-edit-grid { grid-template-columns: 1fr; } }",
    // =====================================================
  ]
}
