...
pub fn css() -> List(String) {
  [
    ...
    ".task-show .task-action-bar { position: sticky; bottom: 0; z-index: 2; padding: 12px 20px; border-top: 1px solid var(--sb-border); display: flex; justify-content: flex-end; flex-wrap: wrap; gap: 10px; background: var(--sb-surface); flex: 0 0 auto; box-shadow: 0 -8px 18px color-mix(in oklab, var(--sb-bg) 12%, transparent); }",
