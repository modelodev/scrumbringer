...
pub fn css() -> List(String) {
  [
    ...
    ".card-detail-actions { display: flex; flex-wrap: wrap; gap: 8px; align-items: center; }",
    ".card-detail-actions .btn { min-height: 36px; }",
    ...
    ".card-detail-action-blocked { color: var(--sb-muted); border-style: dashed; cursor: help; }",
    ".card-detail-action-blocked[aria-disabled='true']:hover { border-color: var(--sb-border); background: var(--sb-elevated); }",
