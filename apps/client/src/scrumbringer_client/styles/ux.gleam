...
pub fn css() -> List(String) {
  [
    ...
    ".task-detail-editor-stack { display: flex; flex-direction: column; gap: 14px; }",
    ".task-detail-summary { display: flex; flex-direction: column; gap: 10px; padding: 12px; border: 1px solid color-mix(in oklab, var(--sb-border) 76%, transparent); border-radius: 10px; background: var(--sb-surface); }",
    ".task-detail-summary-title { font-size: var(--sb-font-sm); font-weight: var(--sb-weight-bold); letter-spacing: var(--sb-letter-label); text-transform: uppercase; color: var(--sb-muted-strong); }",
    ".task-detail-summary-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 10px 14px; }",
    ".task-detail-summary-item { min-width: 0; }",
    ".task-detail-summary-label { font-size: var(--sb-font-sm); font-weight: var(--sb-weight-semibold); color: var(--sb-muted-strong); margin-bottom: 3px; }",
    ".task-detail-summary-value { color: var(--sb-text-strong); font-weight: var(--sb-weight-medium); line-height: var(--sb-line-body); overflow-wrap: anywhere; }",
    ".task-detail-summary-value.muted { color: var(--sb-muted); font-weight: var(--sb-weight-normal); }",
    ...
    ".task-detail-edit-section { display: flex; flex-direction: column; gap: 10px; padding: 0 0 12px; border-bottom: 1px solid color-mix(in oklab, var(--sb-border) 64%, transparent); }",
    ".task-detail-edit-section:last-of-type { padding-bottom: 0; border-bottom: 0; }",
    ".task-detail-edit-section-title { font-size: var(--sb-font-sm); font-weight: var(--sb-weight-bold); letter-spacing: var(--sb-letter-label); text-transform: uppercase; color: var(--sb-muted-strong); }",
