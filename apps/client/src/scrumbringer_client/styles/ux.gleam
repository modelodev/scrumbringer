...
pub fn css() -> List(String) {
  [
    ...
    ".scope-matrix > label { font-weight: 600; color: var(--sb-text); }",
    ...
    ".scope-matrix-head > div { font-size: 12px; font-weight: 700; color: var(--sb-muted); text-transform: uppercase; letter-spacing: 0.05em; }",
    ".scope-matrix-resource { font-weight: 600; }",
    ...
    "@media (max-width: 640px) { .scope-matrix-head, .scope-matrix-row { grid-template-columns: minmax(82px, 1fr) 78px 96px; } .scope-matrix-head > div, .scope-matrix-row > div, .scope-matrix-row > label { padding: 8px 6px; } .scope-checkbox { gap: 4px; font-size: 14px; } .api-token-scope-badges { justify-content: flex-end; max-width: 180px; } }",
    ...
    ".task-details-title { font-size: 13px; letter-spacing: 0.02em; color: var(--sb-muted); font-weight: 600; }",
    ...
    ".task-detail-field-label { font-size: 14px; font-weight: 600; letter-spacing: 0.01em; color: var(--sb-muted-strong); margin-bottom: 4px; }",
    ".task-detail-field-value { font-size: 13px; font-weight: 500; color: color-mix(in oklab, var(--sb-text) 88%, var(--sb-muted)); line-height: 1.45; }",
    ...
    ".task-detail-edit-textarea { min-height: 120px; resize: vertical; line-height: 1.45; }",
    ...
    ".task-section-hint { font-size: 13px; color: var(--sb-muted); margin-bottom: 12px; padding-inline: 2px; line-height: 1.45; }",
