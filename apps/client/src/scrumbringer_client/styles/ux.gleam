...
pub fn css() -> List(String) {
  [
    ...
    ".card-show-actions { display: flex; flex-wrap: wrap; gap: 8px; align-items: center; }",
    ".card-show-actions .btn { min-height: 36px; }",
    ".card-secondary-actions-menu { position: relative; display: inline-flex; }",
    ".card-secondary-actions-trigger { list-style: none; display: inline-flex; align-items: center; justify-content: center; min-width: 40px; min-height: 36px; border: 1px solid var(--sb-border); border-radius: 10px; background: var(--sb-elevated); color: var(--sb-text); padding: 0 12px; font-weight: var(--sb-weight-bold); cursor: pointer; }",
    ...
    ".card-scoped-navigation { display: flex; flex-wrap: wrap; align-items: center; gap: 6px; }",
