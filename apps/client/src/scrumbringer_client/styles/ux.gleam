...
pub fn css() -> List(String) {
  [
    ...
    ".card-inspector-header-stack { display: flex; flex-direction: column; gap: 12px; }",
    ...
    ".card-meta-chip, .inspector-meta-chip { display: inline-flex; align-items: center; gap: 5px; min-height: 26px; border: 1px solid color-mix(in oklab, var(--sb-border) 82%, transparent); border-radius: 999px; background: color-mix(in oklab, var(--sb-elevated) 88%, transparent); padding: 3px 8px; color: var(--sb-muted-strong); font-size: var(--sb-font-sm); line-height: var(--sb-line-tight); }",
    ".card-meta-chip.muted, .inspector-meta-chip.muted { color: var(--sb-muted); }",
    ...
    ".card-ready-to-close-signal { padding: 10px 12px; }",
