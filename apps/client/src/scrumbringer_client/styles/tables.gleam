...
pub fn css() -> List(String) {
  [
    ...
    ".table-badge { display: inline-flex; align-items: center; justify-content: center; min-width: 24px; height: 20px; padding: 0 6px; border-radius: var(--sb-radius-lg); font-size: var(--sb-font-sm); font-weight: var(--sb-weight-semibold); font-variant-numeric: tabular-nums; }",
    ...
    ".templates-expansion { padding: 12px 16px; background: color-mix(in oklab, var(--sb-primary) 4%, var(--sb-surface)); border-radius: 10px; margin: 4px 8px 4px 40px; border: 1px solid color-mix(in oklab, var(--sb-primary) 28%, var(--sb-border)); }",
