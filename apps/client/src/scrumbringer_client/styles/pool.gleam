...
pub fn css() -> List(String) {
  [
    ...
    ".task-card.card-border-gray, .task-card.card-border-red, .task-card.card-border-orange, .task-card.card-border-yellow, .task-card.card-border-green, .task-card.card-border-blue, .task-card.card-border-purple, .task-card.card-border-pink { border-color: color-mix(in oklab, var(--sb-card-accent, var(--sb-border)) 52%, var(--sb-border)); background: color-mix(in oklab, var(--sb-card-accent, var(--sb-surface)) 6%, var(--sb-surface)); }",
    ".task-card.task-blocked.card-border-gray, .task-card.task-blocked.card-border-red, .task-card.task-blocked.card-border-orange, .task-card.task-blocked.card-border-yellow, .task-card.task-blocked.card-border-green, .task-card.task-blocked.card-border-blue, .task-card.task-blocked.card-border-purple, .task-card.task-blocked.card-border-pink { border-color: color-mix(in oklab, var(--sb-card-accent, var(--sb-warning)) 46%, var(--sb-warning)); background: color-mix(in oklab, var(--sb-card-accent, color-mix(in oklab, var(--sb-surface) 92%, var(--sb-warning) 8%)) 6%, color-mix(in oklab, var(--sb-surface) 92%, var(--sb-warning) 8%)); }",
