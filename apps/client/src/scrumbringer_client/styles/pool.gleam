...
pub fn css() -> List(String) {
  [
    ...
    ".task-card.card-border-gray, .task-card.card-border-red, .task-card.card-border-orange, .task-card.card-border-yellow, .task-card.card-border-green, .task-card.card-border-blue, .task-card.card-border-purple, .task-card.card-border-pink { border-color: color-mix(in oklab, var(--sb-card-accent, var(--sb-border)) 58%, var(--sb-border)); box-shadow: inset 0 0 0 1px color-mix(in oklab, var(--sb-card-accent, transparent) 20%, transparent); }",
    ".task-card.task-blocked.card-border-gray, .task-card.task-blocked.card-border-red, .task-card.task-blocked.card-border-orange, .task-card.task-blocked.card-border-yellow, .task-card.task-blocked.card-border-green, .task-card.task-blocked.card-border-blue, .task-card.task-blocked.card-border-purple, .task-card.task-blocked.card-border-pink { border-color: color-mix(in oklab, var(--sb-card-accent, var(--sb-warning)) 48%, var(--sb-warning)); box-shadow: inset 0 0 0 1px color-mix(in oklab, var(--sb-card-accent, transparent) 18%, transparent); }",
