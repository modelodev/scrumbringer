...
pub fn css() -> List(String) {
  [
    ...
    ".modal-header h3 { margin: 0; font-size: var(--sb-font-xl); font-weight: var(--sb-weight-semibold); line-height: var(--sb-line-title); }",
    ...
    ".drilldown-details h3 { font-size: var(--sb-font-lg); font-weight: var(--sb-weight-semibold); line-height: var(--sb-line-title); margin: 0 0 12px 0; }",
    ...
    ".metrics-health-label { font-size: var(--sb-font-sm); color: var(--sb-muted); }",
    ".metrics-health-value { font-size: var(--sb-font-lg); font-weight: var(--sb-weight-semibold); font-variant-numeric: tabular-nums; }",
    ...
    ".metrics-overview-label { font-size: var(--sb-font-sm); color: var(--sb-muted); }",
    ".metrics-overview-value { font-size: var(--sb-font-lg); font-weight: var(--sb-weight-semibold); font-variant-numeric: tabular-nums; }",
    ".metric-box { padding: 12px 16px; background: var(--sb-surface); border: 1px solid var(--sb-border); border-radius: 10px; min-width: 100px; }",
    ".metric-box .metric-label { display: block; font-size: var(--sb-font-sm); color: var(--sb-muted); margin-bottom: 4px; }",
    ".metric-box .metric-value { display: block; font-size: var(--sb-font-2xl); font-weight: var(--sb-weight-bold); font-variant-numeric: tabular-nums; }",
    ".metric-box.applied { border-color: var(--sb-success); background: color-mix(in oklab, var(--sb-success) 10%, var(--sb-surface)); }",
    ".metric-box.applied .metric-value { color: var(--sb-success-text); }",
    ".metric-box.suppressed { border-color: var(--sb-warning); background: color-mix(in oklab, var(--sb-warning) 10%, var(--sb-surface)); }",
    ".metric-box.suppressed .metric-value { color: var(--sb-warning-text); }",
    ...
    ".breakdown-label { color: var(--sb-muted); font-size: var(--sb-font-md); }",
    ".breakdown-value { font-weight: var(--sb-weight-semibold); font-size: var(--sb-font-md); font-variant-numeric: tabular-nums; }",
    ".drilldown-executions h3 { font-size: var(--sb-font-lg); font-weight: var(--sb-weight-semibold); line-height: var(--sb-line-title); margin: 16px 0 12px 0; }",
  ]
}
