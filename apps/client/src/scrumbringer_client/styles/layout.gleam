...
pub fn css() -> List(String) {
  [
    ...
    ".milestone-detail-actions { display: flex; align-items: flex-start; justify-content: flex-end; flex: 1; }",
    ...
    ".card-preview { width: 100%; box-sizing: border-box; border: 1px solid var(--sb-border); border-radius: 10px; background: var(--sb-surface); padding: 10px 12px; display: flex; flex-direction: column; gap: 10px; }",
    ".card-preview-header { display: flex; flex-direction: column; gap: 8px; }",
    ".card-preview-title { display: flex; align-items: center; gap: 6px; text-align: left; border: none; background: transparent; padding: 0; font: inherit; color: inherit; cursor: pointer; }",
    ".card-preview-title .card-title { font-weight: 600; }",
    ".card-preview-body { display: flex; flex-direction: column; gap: 8px; }",
    ".card-preview-tasks { list-style: none; margin: 0; padding: 0; display: flex; flex-direction: column; gap: 6px; }",
    ".card-preview-task-row { margin: 0; padding: 0; list-style: none; }",
    ".card-preview-task { border-radius: 8px; background: color-mix(in oklab, var(--sb-elevated) 88%, transparent); }",
    ".card-preview-overflow { margin: 0; font-size: 11px; color: var(--sb-muted); }",
    ".card-preview-empty { margin: 0; font-size: 11px; color: var(--sb-muted); }",
    ".card-preview-footer { display: flex; justify-content: flex-end; gap: 8px; flex-wrap: wrap; }",
    ...
    ".milestone-details-dialog .milestone-card-progress { font-size: 12px; padding: 2px 9px; }",
    "@media (max-width: 640px) { .milestone-details-dialog .milestone-card-row { grid-template-columns: 1fr; gap: 6px; } }",
    ...
    ".kanban-card-menu { display: inline-flex; position: relative; opacity: 0; transition: opacity 0.15s; }",
    ".kanban-card:hover .kanban-card-menu, .kanban-card:focus-within .kanban-card-menu { opacity: 1; }",
    ".kanban-card-menu-actions { position: absolute; right: 0; top: calc(100% + 6px); display: none; flex-direction: column; min-width: 140px; background: var(--sb-surface); border: 1px solid var(--sb-border); border-radius: 10px; padding: 6px; box-shadow: 0 8px 20px rgba(0, 0, 0, 0.08); z-index: 8; }",
    ".kanban-card-menu:hover .kanban-card-menu-actions, .kanban-card-menu:focus-within .kanban-card-menu-actions { display: flex; }",
    ".kanban-card-menu-option { justify-content: flex-start; text-align: left; border-radius: 8px; }",
