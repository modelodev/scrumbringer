...
pub fn css() -> List(String) {
  [
    ...
    ".milestones-header-filters { padding-top: 2px; border-top: 1px solid color-mix(in oklab, var(--sb-border) 75%, transparent); }",
    ...
    ".milestones-filters { display: flex; flex-wrap: wrap; gap: 8px; justify-content: flex-end; }",
    ...
    "@media (max-width: 768px) { .milestones-header-main { align-items: flex-start; flex-direction: column; } .milestones-toolbar-actions { width: 100%; justify-content: flex-start; } .milestones-filters { justify-content: flex-start; } }",
