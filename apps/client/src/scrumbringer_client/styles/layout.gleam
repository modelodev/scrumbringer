...
pub fn css() -> List(String) {
  [
    ...
    ".center-filters-people { margin-left: 0; }",
    ".center-content { flex: 1; overflow: auto; }",
    ".people-list { display: flex; flex-direction: column; gap: 8px; }",
    ".people-list ul { list-style: none; margin: 0; padding: 0; display: flex; flex-direction: column; gap: 8px; }",
    ".people-row { border: 1px solid var(--sb-border); border-radius: 10px; background: var(--sb-elevated); padding: 8px 10px; }",
    ".people-row-header { display: flex; align-items: center; justify-content: space-between; gap: 8px; }",
    ".people-row-toggle { display: inline-flex; align-items: center; gap: 8px; flex: 1; min-width: 0; background: transparent; border: none; text-align: left; cursor: pointer; padding: 2px 0; }",
    ...
    ".people-status-chip { font-size: 12px; }",
    ".people-row-details { margin-top: 8px; padding-top: 8px; border-top: 1px dashed var(--sb-border); display: grid; grid-template-columns: 1fr; gap: 8px; }",
