...
pub fn css() -> List(String) {
  [
    ...
    ".panel-center { background: var(--sb-surface); border: 1px solid var(--sb-border); border-radius: var(--sb-radius-xl); padding: var(--sb-space-lg); min-width: 0; animation: view-fade-in 0.15s ease; }",
    ...
    ".btn-action-primary { background: var(--sb-primary); border: 1px solid var(--sb-primary); color: var(--sb-inverse); font-weight: 500; border-radius: var(--sb-radius-lg); }",
    ...
    ".task-item { display: flex; align-items: center; justify-content: space-between; padding: 8px 10px; background: var(--sb-elevated); border: 1px solid var(--sb-border); border-radius: var(--sb-radius-md); gap: var(--sb-space-md); animation: task-item-in 0.25s ease; }",
    ...
    ".milestone-detail-title { margin: 0; font-size: 20px; font-weight: 700; }",
    ...
    ".milestone-activate-btn { background: color-mix(in oklab, var(--sb-success) 18%, var(--sb-surface)); border-color: color-mix(in oklab, var(--sb-success) 55%, var(--sb-border)); color: color-mix(in oklab, var(--sb-success) 85%, var(--sb-text)); font-weight: 600; }",
    ...
    ".milestone-row-title-link { appearance: none; border: 0; background: transparent; color: var(--sb-text); font-size: 15px; font-weight: 650; min-width: 0; padding: 0; text-align: left; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; cursor: pointer; }",
    ...
    ".milestone-item-description { margin: 0; color: var(--sb-muted); font-size: 12px; line-height: 1.5; }",
    ".milestone-item-stats { display: inline-flex; align-items: center; gap: 6px; flex-wrap: wrap; }",
    ".milestone-stat-pill { font-size: 10px; font-weight: 500; color: var(--sb-muted); border: 1px solid color-mix(in oklab, var(--sb-border) 70%, transparent); border-radius: 999px; padding: 2px 8px; background: color-mix(in oklab, var(--sb-elevated) 75%, transparent); }",
    ...
    ".milestone-subsection-title { margin: 0; font-size: 10px; font-weight: 500; color: color-mix(in oklab, var(--sb-muted) 88%, var(--sb-text)); text-transform: uppercase; letter-spacing: 0.03em; }",
    ...
    ".milestone-summary-meta { font-size: 11px; font-weight: 450; color: var(--sb-muted); }",
    ...
    ".milestone-summary-heading { margin: 0; font-size: 12px; font-weight: 550; color: color-mix(in oklab, var(--sb-text) 88%, var(--sb-muted)); }",
    ...
    ".milestone-summary-list .detail-label { font-size: 12px; font-weight: 450; color: var(--sb-muted); }",
    ".milestone-summary-list .detail-value { font-size: 12px; font-weight: 500; color: color-mix(in oklab, var(--sb-text) 90%, var(--sb-muted)); }",
    ...
    ".milestone-content-note { border-left: 3px solid color-mix(in oklab, var(--sb-warning) 55%, var(--sb-border)); background: color-mix(in oklab, var(--sb-warning) 8%, var(--sb-surface)); border-radius: 8px; padding: 10px 12px; display: flex; flex-direction: column; gap: 6px; }",
    ...
    ".card-surface-title .card-title, .card-preview-title .card-title, .kanban-card-title .card-title { font-weight: 600; }",
    ...
    ".card-surface-overflow, .card-preview-overflow { margin: 0; font-size: 11px; color: var(--sb-muted); }",
    ".card-surface-empty, .card-preview-empty { margin: 0; font-size: 11px; color: var(--sb-muted); }",
    ...
    ".milestone-task-status { font-size: 11px; color: var(--sb-muted); border: 1px solid var(--sb-border); border-radius: 999px; padding: 1px 8px; background: var(--sb-elevated); }",
    ...
    ".move-menu-trigger { display: inline-flex; align-items: center; gap: 6px; min-height: 28px; border: 1px solid var(--sb-border); border-radius: 999px; background: color-mix(in oklab, var(--sb-elevated) 92%, transparent); color: var(--sb-text); padding: 0 10px; font-size: 12px; font-weight: 600; cursor: pointer; }",
    ...
    ".card-surface-description, .kanban-card-desc { font-size: 13px; color: var(--sb-muted); line-height: 1.4; }",
    ...
    ".kanban-task-item, .card-surface-task-compact { display: flex; align-items: center; gap: 6px; padding: 4px 6px; border-radius: 6px; font-size: 12px; transition: background 0.15s; }",
