...
pub fn css() -> List(String) {
  [
    ...
    // Milestones View
    // =============================================================================
    ".milestones-view { display: flex; flex-direction: column; gap: 12px; }",
    ".milestones-toolbar { background: var(--sb-elevated); border: 1px solid var(--sb-border); border-radius: 12px; padding: 10px 12px; display: flex; flex-direction: column; gap: 10px; }",
    ...
    ".milestones-section { background: var(--sb-elevated); border: 1px solid var(--sb-border); border-radius: 12px; padding: 10px 12px; }",
    ...
    ".milestone-item { border: 1px solid var(--sb-border); border-radius: 10px; background: var(--sb-surface); padding: 10px 12px; display: flex; flex-direction: column; gap: 8px; transition: border-color 0.15s ease, box-shadow 0.15s ease; }",
    ...
    ".milestone-item-actions { display: inline-flex; align-items: center; gap: 8px; }",
    ".milestone-item-title { display: inline-flex; align-items: center; gap: 8px; min-width: 0; }",
    ".milestone-item-name-button { appearance: none; border: none; background: transparent; padding: 0; margin: 0; color: var(--sb-text); font-size: 14px; font-weight: 600; cursor: pointer; text-align: left; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }",
    ".milestone-item-name-button:hover { color: var(--sb-primary); text-decoration: underline; }",
    ".milestone-item-meta { display: inline-flex; align-items: center; gap: 8px; justify-self: end; }",
    ...
    ".milestone-stat-pill { font-size: 11px; color: var(--sb-muted); border: 1px solid var(--sb-border); border-radius: 999px; padding: 2px 8px; background: var(--sb-elevated); }",
