...
pub fn css() -> List(String) {
  [
    ...
    ".milestone-create-actions { margin-top: 6px; padding: 6px 0 2px; border-top: 1px solid color-mix(in oklab, var(--sb-border) 70%, transparent); }",
    ...
    ".milestone-details-dialog { display: flex; flex-direction: column; gap: 12px; }",
    ".milestone-details-dialog .milestone-item-meta { padding: 10px 12px; gap: 12px; border: 1px solid color-mix(in oklab, var(--sb-border) 75%, transparent); border-radius: 10px; background: color-mix(in oklab, var(--sb-elevated) 88%, transparent); }",
    ".milestone-details-dialog .milestone-item-stats { gap: 8px; }",
    ".milestone-details-dialog .modal-tabs.milestone-details-tabs { margin-top: 4px; padding: 6px; border: 1px solid color-mix(in oklab, var(--sb-border) 82%, transparent); border-radius: 10px; background: color-mix(in oklab, var(--sb-surface) 85%, var(--sb-elevated)); display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); }",
    ".milestone-details-dialog .modal-tab { min-height: 34px; }",
    ...
    ".milestone-details-tabpanel { min-height: 300px; }",
    ".milestone-details-content { display: flex; flex-direction: column; gap: 12px; padding-top: 2px; }",
    ".milestone-details-dialog .milestone-subsection { padding: 10px 12px; }",
    ".milestone-details-dialog .milestone-card-row { padding: 8px 10px; }",
