...
pub fn css() -> List(String) {
  [
    ...
    ".milestone-detail-pane { display: grid; grid-template-columns: minmax(0, 1.7fr) minmax(280px, 360px); gap: 14px; align-items: start; }",
    ".milestone-detail-main, .milestone-context-pane, .milestone-detail-empty { background: var(--sb-elevated); border: 1px solid var(--sb-border); border-radius: 12px; padding: 14px; display: flex; flex-direction: column; gap: 14px; min-height: 320px; }",
    ...
    ".milestone-subsection-title { margin: 0; font-size: 11px; color: var(--sb-muted); text-transform: uppercase; letter-spacing: 0.04em; }",
    ".milestone-context-section { border: 1px solid color-mix(in oklab, var(--sb-border) 75%, transparent); border-radius: 10px; background: color-mix(in oklab, var(--sb-elevated) 88%, transparent); padding: 10px 12px; }",
    ".milestone-context-section-title { margin-bottom: 2px; }",
    ...
    ".card-preview-overflow { margin: 0; font-size: 12px; color: var(--sb-muted); }",
    ".card-preview-empty { margin: 0; font-size: 12px; color: var(--sb-muted); }",
    ...
    "@media (max-width: 1280px) { .milestone-detail-pane { grid-template-columns: 1fr; } }",
    "@media (max-width: 1024px) { .milestones-shell { grid-template-columns: 1fr; } .milestones-list-pane { position: static; } }",
    "@media (max-width: 768px) { .milestones-header-main { align-items: flex-start; flex-direction: column; } .milestones-toolbar-actions { width: 100%; justify-content: flex-start; } .milestones-filter-row { justify-content: flex-start; } }",
