...
pub fn css() -> List(String) {
  [
    ...
    ".card-preview { border: 1px solid var(--sb-border); border-radius: 10px; background: var(--sb-surface); padding: 10px 12px; display: flex; flex-direction: column; gap: 10px; }",
    ...
    ".milestone-card-wrapper { display: flex; }",
    ...
    ".move-menu-actions .btn { justify-content: flex-start; text-align: left; border-radius: 8px; }",
