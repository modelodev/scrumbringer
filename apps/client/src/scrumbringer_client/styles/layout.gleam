...
pub fn css() -> List(String) {
  [
    ...
    ".milestone-item-actions-row { margin-top: 2px; display: flex; align-items: center; justify-content: space-between; gap: 10px; width: 100%; }",
    ".milestone-item-actions-main { display: inline-flex; align-items: center; gap: 8px; flex-wrap: wrap; }",
    ".milestone-item-actions-manage { display: inline-flex; align-items: center; gap: 8px; margin-left: auto; }",
    ...
    "@media (max-width: 640px) { .milestone-item-actions-row { align-items: stretch; flex-direction: column; } .milestone-item-actions-main { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); width: 100%; } .milestone-item-actions-main .btn { width: 100%; justify-content: center; } .milestone-item-actions-manage { width: 100%; justify-content: flex-end; margin-left: 0; } }",
