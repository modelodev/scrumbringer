...
pub fn translate(text: Text) -> String {
  case text {
    ...
    text.PlanLens -> "Lente"
    text.PlanLensKanban -> "Kanban"
    text.PlanLensCapabilities -> "Capacidades"
    text.PlanLensBlockers -> "Bloqueos"
    text.PlanLensPeople -> "Personas"
    text.PlanCapabilityMode -> "Vista"
