...
pub fn translate(text: Text) -> String {
  case text {
    ...
    text.Busy -> "Ocupado"
    text.Free -> "Libre"
    text.PeopleSearchPlaceholder -> "Buscar persona"
    ...
    text.PeopleFilterAttention -> "Atencion"
    text.PeopleFilterFree -> "Libres"
    ...
    text.HealthTimeToFirstClaim -> "Tiempo al primer claim"
    text.HealthOk -> "OK"
    text.HealthAttention -> "Atención"
    text.HealthAlert -> "Alerta"
    text.NoSample -> "Sin muestra"
    text.AvgClaimToComplete -> "Promedio claim → completo"
    text.AvgTimeInClaimed -> "Promedio en claimed"
    text.StaleClaims -> "Claims estancados"
    text.LastClaim -> "Último claim"
    ...
    text.MetricsFirstClaimAt -> "Primer claim"
