...
pub fn translate(text: Text) -> String {
  case text {
    ...
    text.PeopleOpenTaskAction -> "Open"
    ...
    text.PeopleActiveSection -> "Working now"
    text.PeopleClaimedSection -> "Claimed, not started"
    text.Drag -> "Drag"
