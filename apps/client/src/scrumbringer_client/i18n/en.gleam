...
pub fn translate(text: Text) -> String {
  case text {
    ...
    text.TaskStateDoneHint -> "Closed and no longer actionable"
    ...
    text.ShowDoneCards -> "Show closed"
