...
pub type Model {
  Model(
    ...
    capability_edit_dialog_id: Option(Int),
    capability_edit_name: String,
    capability_edit_in_flight: Bool,
    capability_edit_error: Option(String),
...
pub fn default_model() -> Model {
  Model(
    ...
    capability_edit_dialog_id: option.None,
    capability_edit_name: "",
    capability_edit_in_flight: False,
    capability_edit_error: option.None,
