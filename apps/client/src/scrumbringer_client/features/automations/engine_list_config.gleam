...
pub fn from_state(
  ...
  engine_list.Config(
    ...
    form_name: workflows.workflow_form_name,
    form_description: workflows.workflow_form_description,
    form_active: workflows.workflow_form_active,
    form_submitting: workflows.workflow_form_submitting,
    form_error: workflows.workflow_form_error,
