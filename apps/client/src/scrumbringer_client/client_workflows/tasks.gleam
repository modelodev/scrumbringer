...
//// - **api.gleam**: Provides task API functions
...
import scrumbringer_client/client_state.{
  type Model, type Msg, Login, MemberActiveTaskFetched, MemberTaskClaimed,
...
pub fn handle_task_released_ok(
  ...
  #(model, effect.batch([fx, api.get_me_active_task(MemberActiveTaskFetched)]))
}
