...
pub fn people_labels_es_test() {
  ...
  i18n.t(locale.Es, text.PeopleColumnFocus) |> assert_equal("Foco")
  i18n.t(locale.Es, text.PeopleColumnScope) |> assert_equal("Alcance")
  i18n.t(locale.Es, text.PeopleColumnLoad) |> assert_equal("Carga")
  i18n.t(locale.Es, text.PeopleGuidanceLoadDescription)
  |> assert_equal("volumen total de trabajo")
  i18n.t(locale.Es, text.PeopleSectionReservedWork)
  |> assert_equal("Reservadas")
  i18n.t(locale.Es, text.PeopleReservedSection) |> assert_equal("Reservadas")
...
pub fn people_labels_en_test() {
  ...
  i18n.t(locale.En, text.PeopleColumnFocus) |> assert_equal("Focus")
  i18n.t(locale.En, text.PeopleColumnScope) |> assert_equal("Scope")
  i18n.t(locale.En, text.PeopleColumnLoad) |> assert_equal("Load")
  i18n.t(locale.En, text.PeopleGuidanceLoadDescription)
  |> assert_equal("total work volume")
  ...
  i18n.t(locale.En, text.PeopleReservedSection) |> assert_equal("Reserved")
