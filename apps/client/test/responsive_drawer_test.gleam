...
fn drawer_html(
  is_open: Bool,
  position: responsive_drawer.DrawerPosition,
  content: Element(TestMsg),
) -> String {
  responsive_drawer.view(is_open, position, NoOp, content)
  |> render_assertions.html
}

pub fn drawer_closed_has_no_open_class_test() {
  let html = drawer_html(False, responsive_drawer.Left, text("Content"))
...
pub fn drawer_open_has_open_class_test() {
  let html = drawer_html(True, responsive_drawer.Left, text("Menu Content"))
...
pub fn drawer_open_has_overlay_test() {
  let html = drawer_html(True, responsive_drawer.Left, text("Content"))
  render_assertions.contains(html, "drawer-overlay")
}

pub fn drawer_left_has_left_class_test() {
  let html = drawer_html(True, responsive_drawer.Left, element.none())
  render_assertions.contains(html, "drawer-left")
}

pub fn drawer_right_has_right_class_test() {
  let html = drawer_html(True, responsive_drawer.Right, element.none())
...
pub fn drawer_left_and_right_have_different_testids_test() {
  drawer_html(True, responsive_drawer.Left, element.none())
  |> render_assertions.contains("left-drawer")
  drawer_html(True, responsive_drawer.Right, element.none())
  |> render_assertions.contains("right-drawer")
}
