...
pub fn empty_card_show_offers_balanced_task_and_subcard_creation_test() {
  ...
  render_assertions.contains(html, "detail-meta")
  render_assertions.contains(html, "data-testid=\"card-header-created-at\"")
  render_assertions.contains(html, "Created 1 Feb 2026")
  render_assertions.contains(html, "title=\"February 1, 2026, 00:00\"")
