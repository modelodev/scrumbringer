...
//// - User registration flow (see `repository/auth/registration.gleam`)
////
//// ## Relationships
////
//// - Uses `sql.gleam` for repository
...
/// Invite link record returned by repository.
...
/// Errors returned by invite link repository.
