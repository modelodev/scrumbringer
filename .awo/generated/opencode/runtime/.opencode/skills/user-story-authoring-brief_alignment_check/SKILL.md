# Skill: user-story-authoring-brief_alignment_check

Use this skill only for workflow `user_story_authoring` step `brief_alignment_check`.
...
- `declared_skill_refs`: `[".opencode/skills/user-story-authoring-brief_alignment_check/SKILL.md"]`
- `materialized_skill_refs`: `[".opencode/skills/user-story-authoring-brief_alignment_check/SKILL.md"]` (exact runtime skill file AWO materialized for this step)
...
- Dependencies already satisfied: repo_context_scan
- Required inputs: repo_context_scan
- Required outputs: brief_alignment_check
- Context mode: `isolated`
- Done criteria: docs/brief.md reviewed and the relevant product guardrails extracted, The proposal is checked against pull workflow, no direct assignment, minimalismo documental, and other applicable constraints, Any conflict with the brief is converted into scope cuts, blockers, or explicit open questions before drafting

Artifact contract details:

- `brief_alignment_check`: emit a durable contract artifact before completing the step
