# Skill: user-story-authoring-story_brief

Use this skill only for workflow `user_story_authoring` step `story_brief`.
...
- `declared_skill_refs`: `[".opencode/skills/user-story-authoring-story_brief/SKILL.md"]`
- `materialized_skill_refs`: `[".opencode/skills/user-story-authoring-story_brief/SKILL.md"]` (exact runtime skill file AWO materialized for this step)
...
- Required outputs: story_brief
- Context mode: `isolated`
- Done criteria: Story id or target doc path proposed under docs/stories/, Actor, need, expected outcome, scope, and non-goals stated, The change is framed as one delivery slice, not a roadmap bundle, Open questions or missing context captured explicitly when needed

Artifact contract details:

- `story_brief`: emit a durable contract artifact before completing the step
